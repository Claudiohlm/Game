...
do
{
    ...
    if(heroi.ClassePersonagemBase() == "Guerreiro")
    {
        Console.WriteLine("Qual o nome do seu Guerreiro? o=|=====>");
    }
    else if(heroi.ClassePersonagemBase() == "Mago")
    {
    ...
    do
    {
        ...
        Console.WriteLine("");
        //Console.Clear();
        Console.WriteLine($"{heroi.NomePersonagemBase()}, digite uma das opções: ");
        ...
        switch(menu)
        {
            ...
            case 5:
                Console.Clear();
                Console.WriteLine($"{heroi.NomePersonagemBase()}, Landir precisa de você. Volte logo!");
                fasePlay = 0;
                play = false;
                break;
            default:
